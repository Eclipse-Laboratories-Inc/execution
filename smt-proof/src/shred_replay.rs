...
impl Replayer {
    ...
    pub fn init_ledger(&mut self, genesis_config: &GenesisConfig) -> Result<(), ReplayerError> {
    ...
    pub fn insert_shred_endwith_slot(&mut self, slot: u64, blockstore: &mut Blockstore) -> Result<(), ReplayerError> {
